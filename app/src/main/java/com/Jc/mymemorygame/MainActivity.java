...
public class MainActivity extends AppCompatActivity {
    ...
    private void doStuff(ImageView iv, int card){
        ...
        //check if what image is selected and save it to temporary variable
        if (cardNumber == 1){
    ...
    private void calculate(){
        ///if the image are equal remove them and add points
